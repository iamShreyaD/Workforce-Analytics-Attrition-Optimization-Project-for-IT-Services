...
# created table called employee_analytics
...
# count of rows of employee_analytics
SELECT COUNT(*) FROM employee_analytics;

# checking termination logic sanity
SELECT `STATUS`, COUNT(*), COUNT(termination_date)
FROM employee_analytics
GROUP BY `STATUS`;

# checking date parsing sanity
SELECT
